...
class UserRegister(MethodView):
	...
	def post(self, user_data):
		...
		if user:
			abort(http_status_code=409, message="There is already another user with that username")
		user = UserModel(
...
class UserLogin(MethodView):
	...
	def post(self, user_data):
		...
		abort(http_status_code=401, message="The username and password are incorrect or invalid.")
