...
class Contact(MethodView):
	...
	def get(self, contact_id):
		return ContactModel.query.get_or_404(contact_id, description="Contact was not found")
	...
	def delete(self, contact_id):
		...
		contact = ContactModel.query.get_or_404(contact_id, description="Contact was not found")
